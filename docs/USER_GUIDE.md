...
<<<<<<< HEAD:final_analysis/pipeline_definitivo/snakemake_pipeline/docs/USER_GUIDE.md
4. **Clustering Analysis**: Groups miRNAs with similar oxidation patterns (runs after Step 2)
5. **Family Analysis**: Analyzes oxidation patterns by miRNA families (runs after Step 2)
6. **Expression Correlation**: Examines relationship between expression and oxidation (runs after Step 2)
7. **Functional Analysis**: Predicts targets and identifies enriched pathways (runs after Step 2)
8. **Biomarker Analysis**: Evaluates diagnostic potential (ROC curves) - integrates all analyses
=======
...
>>>>>>> 352eb6950c566304a08c8054f00dc95591ac07de:docs/USER_GUIDE.md
...
<<<<<<< HEAD:final_analysis/pipeline_definitivo/snakemake_pipeline/docs/USER_GUIDE.md
# Step 3: Clustering Analysis (runs FIRST after Step 2 - discovers structure)
snakemake -j 4 all_step3

# Steps 4, 5, 6 run in parallel after Step 3 (use clustering context)
# Step 4: Family Analysis (compares data-driven clusters with biological families)
snakemake -j 4 all_step4

# Step 5: Expression-Oxidation Correlation (examines expression relationships, can use clustering)
snakemake -j 4 all_step5

# Step 6: Functional Analysis (functional implications with clustering context)
snakemake -j 4 all_step6

# Step 7: Biomarker Analysis (depends on Step 6, integrates all insights) - LAST
...
<<<<<<< HEAD:final_analysis/pipeline_definitivo/snakemake_pipeline/docs/USER_GUIDE.md
├── step3/final/      # Clustering analysis
├── step4/final/      # Family analysis
├── step5/final/      # Expression correlation
├── step6/final/      # Functional analysis
├── step7/final/      # Biomarker analysis
=======
