#!/usr/bin/env python3
"""
Create HTML viewer for Step 2 figures with base64 embedded images
"""
import os
import base64
...
# Lista de figuras con información (actualizada para FIG_2.4)
figures_info = [
...
html_lines = [
    ...
    '        <p><em>Note: Figure 2.8 removed (redundant with FIG_2.16 which uses ALL G>T SNVs)</em></p>',
    '        ',
]

# Agregar cada figura con base64 encoding
...
for fig_file, title, desc in figures_info:
    ...
    print(f"   Encoding {fig_file}...")
    img_base64 = encode_image_base64(fig_path)
    ...
    html_lines.extend([
        ...
        f'            <img src="{img_base64}" alt="{title}" style="max-width: 100%; height: auto;">',
        '        </div>',
        '        ',
    ])
...
# Guardar
output_html = viewer_dir / "step2_EMBED.html"
output_html.write_text('\n'.join(html_lines))
print(f"\n✅ Viewer HTML creado: {output_html}")
